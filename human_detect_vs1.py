'''
No code optimisation + reidentification for every bounding box + no tracking
'''
    ...
    def find(self, img, box):
        ...
        for folder in folders:
            ...
            for f in files:
                ...
                main2 = self.import_from('run_vs1', 'main2')
                
                ret = main2(past_ppl + '/' + folder + '/' + f , './temporaryImg.jpg')
                if(ret == True):
